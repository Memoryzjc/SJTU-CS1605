...
void BattleField::BeforeGame_() {
    ...
    std::vector<Slime_T> playerSlimeTs = this->actors_[0]->ChooseStartingSlime(),
                         enemySlimeTs = this->actors_[1]->ChooseStartingSlime();
...
void BattleField::attack(int firstActor, int secondActor, std::vector<ActionInfo> & actions) {
